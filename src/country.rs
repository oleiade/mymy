macro_rules! country_codes {
    ($($code:ident),+ $(,)?) => {
        ...
        const COUNTRY_DATA: &[(&str, CountryCode)] = &[
...
country_codes!(
    AX, AL, AF, DZ, AS, AD, AO, AI, AQ, AG, AR, AM, AW, AU, AT, AZ, BS, BH, BD, BB, BY, BE, BZ, BJ,
